		...
		return (
			...
			<nav className="navbar navbar-expand-lg navbar-dark bg-primary">
				<div className="container-fluid">
					...
					<button id="github" className="bg-white sticky duration-500 border-0 border-gray-600 fixed w-12 transform hover:-translate-y-3 h-100 text-2xl rounded-full hover:bg-gray-600 hover:text-white text-gray-600" style={{ borderRadius: '50%', width: 30, height:30}}>
						<a href="https://github.com/jocorrei/42faucet" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faGithub}/></a>
					</button>
				</div>
			</nav>
			</MediaQuery>
			...
			<nav className="navbar navbar-expand-lg navbar-dark bg-primary">
				<div className="container-fluid">
					<NotConnectedButton onClick={onClick} />
					<button id="github" className="bg-white sticky duration-500 border-0 border-gray-600 fixed w-12 transform hover:-translate-y-3 h-100 text-2xl rounded-full hover:bg-gray-600 hover:text-white text-gray-600" style={{ borderRadius: '50%', width: 30, height:30}}>
						<a href="https://github.com/gcontarini/42chain_learning_resources" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faGithub}/></a>
					</button>
				</div>
			</nav>
			</MediaQuery>
